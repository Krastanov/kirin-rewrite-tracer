...
| SYSV-010 | [`test_acceptance.py`](../../../test/test_acceptance.py), [`test_session.py`](../../../test/test_session.py) | Passed for valid ordinary entries, six pinned overrides, late/pre-bound/unbound/super calls, same-instance dispatch, and pinned plus synthetic cross-instance delegation trees including mutation ownership. SYSV-004 separately fails invalid-use rejection. |
...
| SYSV-005–007 | [`test_snapshot.py`](../../../test/test_snapshot.py), [`test_model.py`](../../../test/test_model.py) | Implemented; the exhaustive inventory, Rich meta-domain, and representation-path procedures remain incomplete. Ambient forced-color independence of the printable metadata path is covered after the non-terminal console fix. |
| SYSV-012–017 | [`test_mutation.py`](../../../test/test_mutation.py), [`test_stack.py`](../../../test/test_stack.py), [`test_model.py`](../../../test/test_model.py), [`test_acceptance.py`](../../../test/test_acceptance.py), [`test_session.py`](../../../test/test_session.py) | Implemented; the full identity-reuse, all-cardinality/index, stack, delete/detach/container, and incomplete combinations are not all exercised. Cross-instance handlers that return `None` or raise are covered as neutral incomplete. |
