...
| [Trace data and presentation context](context/presentation/index.md) | Router | Selecting snapshot, self-contained HTML, selection, viewer-interaction, accessibility, or styling context | Working only on interception, profiling, or provenance graph storage |
